...
public class IfrFilmes extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        dataPreEstreia = new javax.swing.JFormattedTextField();
        ...
        jLabel9.setText("Data da estréia");

        jLabel3.setText("Data da pré-estreia");

        dataPreEstreia.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.DateFormatter(new java.text.SimpleDateFormat("dd/MM/yyyy HH:mm:ss"))));
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGap(18, 18, 18)
                        .addComponent(dataPreEstreia, javax.swing.GroupLayout.PREFERRED_SIZE, 179, javax.swing.GroupLayout.PREFERRED_SIZE)))
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(dataPreEstreia, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {                                         
        ...
        if (linhaSelecionada >= 0) {
            ...
            if(filmeDoBanco != null){
                ...
                dataPreEstreia.setText(dateTimeFormatter.format(filmeDoBanco.getDataHoraPreEstreia()));
    ...
    private javax.swing.JFormattedTextField dataPreEstreia;
    ...
    private Filme getFilme() {
        ...
        if(!nomeFilmeText.getText().equals("") &&
                !dataEstreia.getText().equals("") && !dataPreEstreia.getText().equals("")){
            filme = new Filme();
