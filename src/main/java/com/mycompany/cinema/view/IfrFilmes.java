...
//    private List<ItemPedido> listaItemPedido = new ArrayList<>();
    ...
    //método para recuperar um pedido criado por meio dos componentes de entrada
...
//    private ItemPedidoModel itemPedidoModel = new ItemPedidoModel(listaItemPedido);
//    private double total = 0.0;

    //adiciona um item do pedido na JTable
    private void addItensPedido() {
        Filme filme = getFilme();//recupera o pedido criado
//        itemPedido = new ItemPedido();//cria o item do pedido
//        itemPedido.setProduto((Produto) cbProduto.getSelectedItem());
//        itemPedido.setQuantidade(Double.parseDouble(tfQuantidade.getText()));
//        jTable1.setModel(itemPedidoModel);
//        itemPedidoModel.insertModel(itemPedido);
//        total += itemPedido.subTotal();//calcula o subtotal do item do pedido
//        pedido.setTotalPedido(total);//e seta no total do pedido
//        tfTotal.setText(String.valueOf(pedido.getTotalPedido()));
